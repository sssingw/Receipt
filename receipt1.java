...
public class receipt1 {
	...
	public static void main(String[] args) {		
		...
		int K15_iprice = 66000;  															 			 												// 총 지불금액 저장 변수
		...
		System.out.printf("%s : %20s\n", "주 소", "경기 성남시 분당구 황새울로351번길 10");							//주소와 해당 주소를 출력
		System.out.printf("%s", "1층\n");																										//주소와 해당 주소를 출력
		...
		System.out.println("-------------------------------------------------------------");												//줄띄움을 위해 출력 
		System.out.printf("%37s", "* 감사합니다 *\n");																					//감사합니다 출력
		System.out.printf("%57s", "표준V2.08_20200212\n");																		//표준버전을 출력
	}
